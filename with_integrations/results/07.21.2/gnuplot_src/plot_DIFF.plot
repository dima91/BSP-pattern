...
set ylabel	"{/*1.5 Timme difference (usecs)}"
set title	"{}"
set key top right
set key font ",14"
set xtics font ",14"
...
plot	'./gnuplot_src/DIFF.data'	index 0 with linespoints linestyle 1 title "2^{15}", \
		''							index 1 with linespoints linestyle 2 title "2^{20}", \
		''							index 2 with linespoints linestyle 3 title "2^{25}"